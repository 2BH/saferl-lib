...
"""
This is a modified version of stable_baselines3 SAC Implementation as a baseline
"""

class SAC(SafeOffPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        cost_constraint: Union[float, list] = [2, None], # Unused for far
        use_sde: bool = False,
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                target_q_values = replay_data.rewards - self.cost_weight_factor * replay_data.costs + (1 - replay_data.dones) * self.gamma * next_q_values
